# Sistema de Diseño - INAPROF

## 1. Contexto Institucional
**INAPROF** (Instituto Nacional de Capacitación para el Ascenso Profesional) es una entidad con sede en Huancayo orientada a la educación online, especializada en la actualización profesional en áreas de derecho, gestión pública y formación de árbitros. Esta guía técnica establece las directrices visuales para asegurar que los sistemas internos y los entornos virtuales de aprendizaje proyecten una imagen de excelencia, formalidad e innovación.
...
:root {
  /* Brand Colors */
  --inaprof-primary: #072146;   /* Azul Marino - Para fondos, barras de navegación y textos primarios */
  --inaprof-secondary: #b78e24; /* Dorado - Para acentos, isotipos, botones y llamadas a la acción */
  
  /* Neutrals */
  --inaprof-white: #ffffff;
}
3. Tipografía
...
Versión Principal (Apilada): Texto "INAPROF" en --inaprof-primary y trazo curvo en --inaprof-secondary sobre fondos claros. El descriptor "CAPACITACIÓN PROFESIONAL" debe ir justificado a la derecha debajo de la marca.
...
Alto Contraste (Negativo): Logo completamente en --inaprof-white. Uso exclusivo para superposiciones sobre la variante de fondo --inaprof-primary.
...
Botones (Buttons): * Radios de borde tipo pill (completamente redondeados).

Geometrías de pestaña (con bordes asimétricos, dejando una o dos esquinas rectas).

Estilo Solid: Fondo en --inaprof-secondary con el texto en blanco.

Estilo Outline: Borde fino en --inaprof-secondary con fondo transparente.
...
Este video es un ejemplo representativo del contenido sobre derecho procesal y penal que instituciones como INAPROF fomentan en sus diplomados y programas de especialización.
